...
$query = "SELECT * FROM common_number WHERE date = ? AND time_period = ?";
        ...
        <main id="main-dash" class="col-md-9 col-lg-10 p-4 overflow-auto h-100">
            ...
            <div class="row">
                <div class="col-md-12 text-center mt-5">
                    <h2 class="text-primary">Today's Common Numbers (<?php echo date('d/m/Y'); ?>) -
            ...
            <div class="row center">
                <div class="col-md-8 bg-white shadow-sm rounded-3 p-4">
                    ...
                    <?php } else { ?>
                    <p class="text-center text-danger mt-3">No common numbers available for today.</p>
                    <?php } ?>

                    <!-- Button to View List Page -->
                    <div class="text-center mt-4">
                        <a href="add-common.php?time_period=<?php echo $selectedTimePeriod; ?>"
                            class="btn btn-primary w-25">Add Common Numbers</a>
                    </div>
                </div>
            </div>
        </main>
