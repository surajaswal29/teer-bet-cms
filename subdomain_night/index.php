        ...
        <div class="col-md-8" style="margin-top: 2rem;">
            ...
            <div class="table-responsive" style="margin-top: 0.5rem;">
                <table class="table table-bordered m-0">
                    ...
                    $fetchResultsQuery = "SELECT * FROM result_update WHERE time_period = 'night' AND date = '$todayDate' ORDER BY id DESC LIMIT 1";
                    ...
                    <thead class="bg-shillong-txt text-dark">
                        <tr>
                            <th colspan="2" class="text-center">SHILLONG NIGHT</th>
                        </tr>
                    </thead>
                    <tbody>
